...
=======
                    <li class="nav-item"><a class="nav-link" style="color:#ffffff" href="#services">Beranda</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:#ffffff" href="#portfolio">Portfolio</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:#ffffff" href="#kegiatan">Kegiatan</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:#ffffff" href="#team">Pengurus</a></li>
                    <li class="nav-item"><a class="nav-link" style="color:#ffffff" href="#contact">Kontak</a></li>
>>>>>>> f9b6a80 (landingpage)
    ...
    <header class="masthead">
        <div class="container">
<<<<<<< HEAD
            <div class="masthead-subheading">Welcome To MASFO!</div>
...
<<<<<<< HEAD
                    ...
                    organisasi, dan
=======
                    dari masjid at thohir. Dalam aplikasi ini, terdapat pula sezione lengkap tentang masjid,struktur organisasi, dan
>>>>>>> f9b6a80 (landingpage)
...
<<<<<<< HEAD
                ...
                <h3 class="section-subheading text-muted">Berikut ini adalah layanan yang kami sediakan</h3>
=======
...
=======
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x bg-blue"></i>
                        <img src="assets/img/inventaris.png" class="fa-stack-1x fa-inverse" width="80"
                            alt="">
                    </span>
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x bg-blue"></i>
                        <img src="assets/img/pengurus.png" class="fa-stack-1x fa-inverse"
                            width="80"alt="">
                    </span>
...
=======
                <h2 class="section-heading text-uppercase">Portfolio</h2>
                <h3 class="section-subheading text-muted">Portofolio Beberapa Acara yang Sudah di Selenggarakan</h3>
>>>>>>> f9b6a80 (landingpage)
            </div>
            <div class="row">
...
=======
    ...
    <section class="page-section" id="kegiatan">
        <div class="container">
            ...
            <ul class="timeline">
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/kt1.jpeg"
                            alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>02 Mei 2022</h4>
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut
                                ...
                                unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
=======
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/kt2.jpg"
                            alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut
                                ...
                                unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
=======
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/kt3.jpg"
                            alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>11 April 2023</h4>
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut
                                ...
                                unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
=======
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/kt4.jpg"
                            alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>1 Juni 2022</h4>
...
=======
                        ...
                        <div class="form-group mb-md-0">
                            ...
                            <input class="form-control" id="phone" type="tel"
                                placeholder="Nomor Handphone *" data-sb-validations="required" />
...
=======
                ...
                <!-- Submit Button-->
                <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase disabled"
                        style="background-color:rgb(47, 107, 130)" id="submitButton" type="submit">Kirim</button>
                </div>
>>>>>>> f9b6a80 (landingpage)
            </form>
        </div>
...
=======
                                ...
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/pp1.jpg"
                                    alt="..." />
                                <button class="btn btn-primary btn-xl text-uppercase"
                                    style="background-color:rgb(47, 107, 130)" data-bs-dismiss="modal"
                                    type="button">
                                    <i class="fas fa-xmark me-1"></i>
                                    Close
>>>>>>> f9b6a80 (landingpage)
...
=======
                                ...
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/pp2.jpg"
                                    alt="..." />
                                <button class="btn btn-primary btn-xl text-uppercase"
                                    style="background-color:rgb(47, 107, 130)" data-bs-dismiss="modal"
                                    type="button">
...
=======
                                ...
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/pp3.jpg"
                                    alt="..." />
                                <button class="btn btn-primary btn-xl text-uppercase"
                                    style="background-color:rgb(47, 107, 130)" data-bs-dismiss="modal"
                                    type="button">
...
=======
                                ...
                                <p class="item-intro text-muted">Berikut adalah susana masjid at thohir pada malam hari
                                    ...
                                    nya.</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/pp4.jpg"
                                    alt="..." />
                                <button class="btn btn-primary btn-xl text-uppercase"
                                    style="background-color:rgb(47, 107, 130)" data-bs-dismiss="modal"
                                    type="button">
...
=======
                                ...
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/pp5.jpeg"
                                    alt="..." />
                                <button class="btn btn-primary btn-xl text-uppercase"
                                    style="background-color:rgb(47, 107, 130)" data-bs-dismiss="modal"
                                    type="button">
...
=======
                                ...
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/pp6.jpg"
                                    alt="..." />
                                <button class="btn btn-primary btn-xl text-uppercase"
                                    style="background-color:rgb(47, 107, 130)" data-bs-dismiss="modal"
                                    type="button">
