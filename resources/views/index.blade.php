        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <div class="d-lg-flex col-lg-3 justify-content-lg-end">
                    <a href="/login" class="btn btn-success shadow-sm m-1">Login</a>
                    <a href="/register" class="btn btn-info shadow-sm m-1">Register</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section class="page-section" id="deskripsi">
        <div class="container">
            <div class="text-center">
                ...
                <p id="about" class="lead fw-normal text-dark-50 mb-0">Hai sobat muslim, selamat datang di
                    SIMASJID
        ...
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x bg-blue"></i>
                        <img src="assets/img/pengurus.png" class="fa-stack-1x fa-inverse" width="80"
                            alt="">
                    </span>
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Berikut Adalah Dokumentasi dari Beberapa Acara yang Sudah di
                    Selenggarakan</h3>
            </div>
            <div class="row">
