    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Pengurus</h6>
            </div>
            <div class="card-body">
                <form method="post" action="/dashboard/pengurus">
                    @csrf
                    <div class="form-group row">
                        <label for="nama_pengurus" class="col-4 col-form-label">Nama Pengurus</label>
                        <div class="col-8">
                            <input id="nama_pengurus" name="nama_pengurus" type="text" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="kode_pengurus" class="col-4 col-form-label">Kode Pengurus</label>
                        <div class="col-8">
                            <input id="kode_pengurus" name="kode_pengurus" type="text" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select id="jabatan_id" name="jabatan_id" type="text" class="form-control" required>
