...
@section('admindata')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="post" action="/dashboard/donasi/{{ $donasi->id }}">
                    @csrf
                    @method('put')
                    <div class="form-group row">
                        <label for="tanggal" class="col-4 col-form-label">Tanggal Donasi</label>
                        <div class="col-8">
                            <input id="tanggal" name="tanggal" value="{{ $donasi->tanggal }}" type="date"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="nominal" name="nominal" value="{{ $donasi->nominal }}" type="number"
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="nama_donatur" name="nama_donatur" value="{{ $donasi->nama_donatur }}" type="text"
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
