...
@section('admindata')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="post" action="/dashboard/inventaris/{{ $inventaris->id }}">
                    @csrf
                    @method('put')
                    <div class="form-group row">
                        <label for="kode" class="col-4 col-form-label">Kode</label>
                        <div class="col-8">
                            <input id="kode" name="kode" max="5" value="{{ $inventaris->kode }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="nama_barang" name="nama_barang" value="{{ $inventaris->nama_barang }}" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="jumlah" name="jumlah" value="{{ $inventaris->jumlah }}" type="number"
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="kondisi_barang" name="kondisi_barang" value="{{ $inventaris->kondisi_barang }}"
                                type="text" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
